...
Rails.application.config.sorcery.submodules = [:user_activation, :remember_me, :reset_password, :brute_force_protection, :activity_logging, :session_timeout]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `50`
    #
    user.consecutive_login_retries_amount_limit = 20
